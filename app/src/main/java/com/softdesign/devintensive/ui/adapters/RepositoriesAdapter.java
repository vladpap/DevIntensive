...
/**
 * Created by vladimirpapin on 15.07.16.
 */
public class RepositoriesAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (itemView == null) {
            itemView = mInflater.inflate(R.layout.item_repositoris_list, parent, false);
        }

        TextView repoName = (TextView) itemView.findViewById(R.id.repository_user_item);
